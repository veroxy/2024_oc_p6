    ...
    <div class="col-md-12">
        <figure class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
            <figcaption class="col-6 p-4 d-flex flex-column position-static">
                ...
                <p class="card-text mb-auto">Donnez une nouvelle vie à vos livres en les échangeant avec d'autres amoureux de la lecture. Nous croyons en la magie du partage de connaissances et d'histoires à travers les livres. </p>
            ...
            <div class="col">
                <figure class="card border-0 shadow-sm rounded rounded-4">
                    <!--<svg class="bd-placeholder-img card-img-top" width="100%" height="225"
                         ...
                         focusable="false">
                        <title><?php /*= $book->getTitle() */?></title>
                        <rect width="100%" height="100%" fill="#55595c"></rect>
                        <text x="50%" y="50%" fill="#eceeef" dy=".3em"><?php /*= $book->getTitle() */?></text>
                    </svg>
-->
                    <div>
